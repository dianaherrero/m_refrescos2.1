...
HD_PWD='C:/Users/sed/Desktop/m_refrescos2/m_refrescooos/m_refrescooos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maq_refrescos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maq_refrescos.tcl
