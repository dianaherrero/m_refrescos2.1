...
HD_PWD='C:/Users/sed/Desktop/m_refrescos2/m_refrescooos/m_refrescooos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log maq_refrescos.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source maq_refrescos.tcl -notrace
